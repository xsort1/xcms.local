...
<head>
    ...
    <title>404 Страница не найдена. Но мы можем ее сделать - www.xsort.ru веб-студия</title>
    <meta name="author" content="www.xsort.ru">
    <meta name="keywords" content='www.xsort.ru - разработка веб-сайтов, страниц, интернет магазинов, блогов, лэндингов, мобильных приложений, SEO, расуркутка сайтов'>
    <meta name="description" content='www.xsort.ru - разработка веб-сайтов, страниц, интернет магазинов, блогов, лэндингов, мобильных приложений, SEO, расуркутка сайтов'>
    <meta property="og:description" content='www.xsort.ru - разработка веб-сайтов, страниц, интернет магазинов, блогов, лэндингов, мобильных приложений, SEO, расуркутка сайтов' />
    <meta property="og:image" content='' />
    <meta property="og:title" content='Разработка сайтов - www.xsort.ru' />
    <meta property="og:site_name" content='Разработка сайтов - www.xsort.ru' />
    <style>
        {literal}
        ...
        * { margin: 0; padding: 0;}
        ...
        .text-block {padding-top:70px;}
        body {background: #d8765d; color:#fff; font-family: "Trebuchet MS";}
        center {font-size: 15px;color:#fff;}
        .container h1 {font-size: 110px; color:#fff; line-height: 1; margin:0; }
        .underh {font-size: 24px; margin-bottom:15px; color:#fff;}
        .jerry_lh, .animated_lh {top:215px;}
        a {color:  #2a6496; font-weight: bold;}
        a: hover {color:#715382}
        .maybe {color:#fad399; font-weight: normal;}
    ...
    <div class="row centered">
        <div class="col-sm-4">
            <div class="bill">
                ...
                <div class="hand make_it_right_hand"><span class="hand_parts"><span></span></span></div>
        ...
        <div class="col-sm-8 text-block">
            ...
            <center class="underh">запрашиваемая страница не найдена</center>
            <center class="maybe">Вы можете перейти на <a href="/">главную</a> или мы можем создать эту веб-страницу специально для Вас =)</center><br /><br />
            <center >А может быть вы хотите разработать целый сайт? Это тоже к нам!</center><br />
            <center class="maybe"><a href="http://xsort.ru">Веб-студия Xsort</a> - команда профессионалов</center>
            <center><a href="http://xsort.ru" class="maybe">разработка веб-сайтов, страниц, интернет магазинов, блогов, лэндингов, мобильных приложений, SEO, расуркутка сайтов</a></center>
        </div>
    </div>
</section>
